...
'</div>'+
    ...
    $('#beefBtn').click(function(){
        $(".flex-container").empty();
        $('.flex-container').append(' <h3> Beef Pepperoni </h3>'+
        ' <div class="row">'+
        '<div class="col-md-4">'+

        '<div class="items border">'+
            '<div><img src="images/beef.jpg" alt=""></div>'+
            '<div class = "itemsBtn"><a class = "addToCart" href="#" nameData = "Large Beef" priceData = "1500">'+
                '<button class = "block" id="chicBtn">Large Beef Peperoni <br> Ksh 1500</button></a></div>'+
        '</div>'+
        ...
        '<div class="col-md-4">'+
            ...
            '<div class="items border">'+
                '<div><img src="images/beef.jpg" alt=""></div>'+
            '<div class = "itemsBtn"><a class = "addToCart" href="#" nameData = "Medium Beef" priceData = "1000">'+
                '<button class = "block" id="hawaiBtn">Medium Beef Peperoni <br> Ksh 1000</button></a></div>'+
                '</div>'+
            ...
            '<div class="col-md-4">'+
                ...
                '<div class="items border">'+
                    '<div><img src="images/beef.jpg" alt=""></div>'+
            '<div class = "itemsBtn"><a class = "addToCart" href="#" nameData = "Small Beef" priceData = "500">'+
                '<button class = "block" id="vegBtn">Small Beef Peperoni<br> Ksh 500 </button></a></div>'+
                '</div>'+
